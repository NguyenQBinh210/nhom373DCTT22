<div style="display: flex;justify-content: center;">
    <button style="width:150px;height: 75px;border-radius: 20px;border:none;background-color: green;"><a href="dang_vien.php" style="color:#ffffff;text-decoration: none;">Quay lại</a>
</button></div>
<?php
